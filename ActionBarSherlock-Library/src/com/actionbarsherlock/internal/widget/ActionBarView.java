...
import com.actionbarsherlock.view.Tela;
...
public class ActionBarView extends AbsActionBarView {
    ...
    private final OnClickListener mUpClickListener = new OnClickListener() {
        public void onClick(View v) {
            mWindowCallback.onMenuItemSelected(Tela.FEATURE_OPTIONS_PANEL, mLogoNavItem);
        }
    };
     ...
     */
    public void setWindowCallback(Tela.Callback cb) {
        mWindowCallback = cb;
    }
